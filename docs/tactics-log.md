...
| 2026-06-07 | TimeBrain gate 2 + movetime-exact fix @ 9f954ab | 266/299 | −7 vs 273, within floor (clean idle run, reproduced 266 twice); note: the WAC canary is movetime-based so carries ±several jitter from per-position node-count variance — the real Gate-2 arbiter is the 8+0.08 SPRT |
