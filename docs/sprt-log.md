...
| 2026-06-07 | **TimeBrain gate 1 — reserve/stability/cap** (M6.2) | conthist | [0,5] | 1970 | 582-433-955 | **H1: +26.3 ±10.3** (0 timeouts; ZERO search knowledge — same tree/eval/bench 54728, pure clock allocation; the field-telemetry headliner pays) | 54728 |
| 2026-06-07 | TimeBrain gate 2 BUNDLE (panic+won-fast+catch-up) (M6.2) | timebrain1 | [0,5] | 1396 | 330-396-670 | **H0 (stopped decisive): −16.4 ±12.0** — the bundle loses to Gate 1; won-fast (50%% on eval≥+500) the prime suspect (a +500 pos at 2800 is often sharp, not won). Carving won-fast, re-gating panic+catch-up | 54728 |
| 2026-06-07 | TimeBrain gate 2 carve (panic+catch-up, won-fast removed) (M6.2) | timebrain1 | [0,5] | 494 | 107-125-262 | **H0 (stopped, 2nd negative): −12.7 ±18.9** — carving won-fast did NOT fix it, so panic-extend (50cp/d8 too trigger-happy) and/or catch-up also hurt at this TC. Whole adaptive layer REVERTED; **TimeBrain v1 = Gate 1 (reserve+stability+cap, +26) is the shipped deliverable**; adaptive ideas deferred to M7 TimeBrain-v2 (Lichess-specific, gauntlet-tuned thresholds) | 54728 |
| 2026-06-07 | *(probe sweep, no gate)* margin candidates C2/C3/C4 (M6.1 T9) | conthist | — | 3×400 | — | **margins already calibrated** — tighter −15.7 ±25.0 (hurts), looser 0.0 ±23.3, adaptive null-R +2.6 ±23.7; nobody clears the +10 bar, no SPRT spent; M4-era values survived the M5 eval transition (the Q-mg coincidence held); canaries 272/272/270 | 54728 |
