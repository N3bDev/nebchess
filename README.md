...
A from-scratch UCI chess engine in Rust. Measured **2827 ± 16** (10+0.1, anchored vs a 3-family pool, engine-default config — book/Syzygy are live-deploy multipliers on top).1, anchored vs a 3-family pool — see docs/strength-log.md for caveats). **M6 target: 2900 (stretch 3000).**
